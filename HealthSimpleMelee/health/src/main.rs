...
fn main() -> BError {
    ...
    let context = BTermBuilder::new()
        ...
        .with_font("dungeonfont.png", 32, 32)// <callout id="co.hsmh.dfont" />
        .with_font("terminal8x8.png", 8, 8)// <callout id="co.hsmh.tfont" />
        .with_simple_console(DISPLAY_WIDTH, DISPLAY_HEIGHT, 
            "dungeonfont.png")// <callout id="co.hsmh.scons" />
        .with_simple_console_no_bg(DISPLAY_WIDTH, DISPLAY_HEIGHT, 
            "dungeonfont.png")
        .with_simple_console_no_bg(SCREEN_WIDTH*2, SCREEN_HEIGHT*2, 
            "terminal8x8.png")// <callout id="co.hsmh.hudcons" />
        .build()?;
    //END: context
